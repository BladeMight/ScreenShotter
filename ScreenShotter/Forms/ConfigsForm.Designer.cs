namespace ScreenShotter
{
    partial class ConfigsForm
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.lbl_WShadow = new System.Windows.Forms.Label();
        	this.nud_WShadow = new System.Windows.Forms.NumericUpDown();
        	this.sound = new System.Windows.Forms.CheckBox();
        	((System.ComponentModel.ISupportInitialize)(this.nud_WShadow)).BeginInit();
        	this.SuspendLayout();
        	// 
        	// consCheckbox
        	// 
        	...
        	this.dfltButton.Location = new System.Drawing.Point(110, 154);
        	...
        	// lbl_WShadow
        	// 
        	this.lbl_WShadow.AutoSize = true;
        	this.lbl_WShadow.Location = new System.Drawing.Point(11, 131);
        	this.lbl_WShadow.Name = "lbl_WShadow";
        	this.lbl_WShadow.Size = new System.Drawing.Size(143, 13);
        	this.lbl_WShadow.TabIndex = 14;
        	this.lbl_WShadow.Text = "Windows shadow offset (px):";
        	// 
        	// nud_WShadow
        	// 
        	this.nud_WShadow.Location = new System.Drawing.Point(225, 128);
        	this.nud_WShadow.Maximum = new decimal(new int[] {
			50,
			0,
			0,
			0});
        	this.nud_WShadow.Name = "nud_WShadow";
        	this.nud_WShadow.Size = new System.Drawing.Size(55, 20);
        	this.nud_WShadow.TabIndex = 15;
        	// 
        	// sound
        	// 
        	this.sound.AutoSize = true;
        	this.sound.Location = new System.Drawing.Point(248, 12);
        	this.sound.Name = "sound";
        	this.sound.Size = new System.Drawing.Size(32, 17);
        	...
        	this.Controls.Add(this.nud_WShadow);
        	this.Controls.Add(this.lbl_WShadow);
        	...
        	((System.ComponentModel.ISupportInitialize)(this.nud_WShadow)).EndInit();
        ...
        private System.Windows.Forms.Label lbl_WShadow;
        private System.Windows.Forms.NumericUpDown nud_WShadow;
